...
export default function HistogramDetailError({ error, reset }: { error: Error; reset: () => void }) {
  return (
    <div style={{ maxWidth: 600, margin: "80px auto", textAlign: "center" }}>
      <div className="halo-card" style={{ padding: 40 }}>
        ...
        <div style={{ display: "flex", gap: 12, justifyContent: "center" }}>
          ...
          <Link href="/histograms" style={{ color: "var(--halo-cyan)", textDecoration: "none", fontWeight: 600, padding: "8px 20px" }}>
            ← Back to Histograms
          </Link>
        </div>
      </div>
